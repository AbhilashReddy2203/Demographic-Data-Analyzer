...
def calculate_demographic_data():
    # Load the dataset
    url = 'https://raw.githubusercontent.com/Chelsea-Myers/demographic-data-analyzer/main/adult.data.csv'
    df = pd.read_csv(url, names=["age", "workclass", "fnlwgt", "education", "education-num", "marital-status",
